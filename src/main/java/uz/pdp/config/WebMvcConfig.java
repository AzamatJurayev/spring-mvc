...
public class WebMvcConfig implements WebMvcConfigurer {
    ...
    DriverManagerDataSource getDataSource() {
        ...
        dataSource.setPassword("11221122");
        return dataSource;
    }
    ...
    @Bean
    public ClassRepositoryC getClassDAO(){
        return new ClassRepositoryImpl(getDataSource());
    }

    @Bean
    public GroupRepository getGroupDAO(){ return  new GroupRepositoryImpl(getDataSource());}
